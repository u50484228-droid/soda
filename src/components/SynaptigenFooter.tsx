...
interface SynaptigenFooterProps {
  onOpenPolicy: (type: 'contact' | 'terms' | 'disclaimer' | 'privacy' | 'shipping' | 'refund' | 'order-support') => void;
}

export const SynaptigenFooter: React.FC<SynaptigenFooterProps> = ({ onOpenPolicy }) => {
  return (
    <footer className="bg-[#0e2238] text-slate-300 text-xs py-16 border-t border-slate-800">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-center">
        
        {/* Navigation Links (Matches Screenshot 5) */}
        ...
        {/* Vendor and BuyGoods Support Notice (Matches Screenshot 5) */}
        ...
        {/* FDA Statement (Matches Screenshot 5) */}
        ...
        {/* Retailer Disclosure (Matches Screenshot 5) */}
        <p className="text-[11px] leading-relaxed text-slate-400 max-w-4xl mx-auto">
        ...
        {/* Google Advertising Disclosure (Matches Screenshot 5) */}
        ...
        {/* Copyright (Matches Screenshot 5) */}
        <div className="pt-4 border-t border-slate-800 text-[11px] text-slate-400">
          Copyright © 2026 Synaptigen. All Rights Reserved.
        </div>
